...
## ➕ LEVEL 1: BASIC OPERATIONS (Class 2–4)
...
## 🔢 LEVEL 2: CORE NUMBER SKILLS (Class 4–6)

### 8️⃣ Factors & Multiples
...
## 📊 LEVEL 3: COMMERCIAL MATH (Very Important for Placements)
...
### 1️⃣3️⃣ Ratio & Proportion

* Ratios
* Proportions
* Direct & inverse proportion

### 1️⃣4️⃣ Profit, Loss & Discount

* Cost price, selling price
* Profit % & loss %
* Successive discount

### 1️⃣5️⃣ Simple Interest

* Formula
* Time, rate, principal problems

### 1️⃣6️⃣ Compound Interest
...
## ⏱️ LEVEL 4: TIME & WORK (Placement Favorite)
...
### 1️⃣9️⃣ Algebra Basics

* Variables
* Simple equations
* Linear equations

### 2️⃣0️⃣ Geometry Basics
...
### 2️⃣4️⃣ Permutation & Combination (Basics)

* Arrangements
* Selections

### 2️⃣5️⃣ Probability (Basic)
...
## 🧠 LEVEL 7: LOGICAL APTITUDE (Non-Math but Tested)
